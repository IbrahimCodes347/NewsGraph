...
export function Brand() { return <Link href="/" className="brand" aria-label="NewsGraph home">
<span className="brand-mark">✳</span> newsgraph<span className="brand-dot">.</span>
</Link>; }
...
<Link href="https://github.com/thepeternemec/NewsGraph">GitHub <ArrowUpRight size={14}/>
</Link>
</footer>; }
