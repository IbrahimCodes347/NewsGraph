  ...
  return (
    <div className="scanner">
      <div className="windowbar">
        ...
        <span className="title">newsgraph — live terminal</span>
      ...
      <div className="terminal-feed">
        ...
        {recent.length === 0 && (
          <div className="feed-line">
            ...
            <span className="src">newsgraph</span>
          </div>
        )}
        </div>
    </div>
...
const PLACEHOLDER: RecentItem[] = [
  { beat_label: "Markets", lede: "Scanning thousands of sources for the first signal.", source: "NewsGraph", url: "#", corroboration: 0 },
  { beat_label: "Policy", lede: "Clustering stories before they reach the mainstream.", source: "NewsGraph", url: "#", corroboration: 0 },
  { beat_label: "AI", lede: "Structured, filtered, ready for agents and humans.", source: "NewsGraph", url: "#", corroboration: 0 },
];
