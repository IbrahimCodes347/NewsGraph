...
const COPIES = [
    { src: "apps/worker/src/ingest-news.ts", dst: "worker/ingest-news.ts", rewrite: [['from "@newsgraph/db"', 'from "../db/index.ts"'], ['from "./newsapi.js"', 'from "./newsapi.ts"']] },
    ...
    ...["news", "news-routes", "mcp"].map(name => ({ src: `apps/api/src/lib/${name}.ts`, dst: `api/${name}.ts`, rewrite: [
            ...
            ['from "@newsgraph/db"', 'from "../db/index.ts"'], ['from "@newsgraph/contracts"', 'from "../contracts/index.ts"'],
        ...
        // API app + libs
    {
        ...
        rewrite: [
            ...
            ['from "@newsgraph/contracts"', 'from "../contracts/index.ts"'],
            ['from "@newsgraph/db"', 'from "../db/index.ts"'],
